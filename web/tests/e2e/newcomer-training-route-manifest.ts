...
export const learnerStaticRoutes: readonly NewcomerTrainingAuditRoute[] = [
  ...
  },
  {
    id: "L-03B",
    label: "客户常见问答学习专题",
    path: "/sales-trainer/learning-topics/customer-faq",
    critical: true,
    expectText: [/客户常见问答|问答卡片|口播演练/],
    forbiddenText: [/TrainingJourney/i, /\brevision\b/i, /trace[_-]?id/i, /\bE2E\b/i, /\be2e\b/, /\bmock\b/i, /\bseed\b/i, /\[HTTP_/],
  },
  {
    id: "L-03C",
    label: "客户常见问答 AI 教练",
    path: "/sales-trainer/learning-topics/customer-faq/coach",
    critical: true,
    expectText: [/客户常见问答|AI 教练|练习/],
    forbiddenText: [/TrainingJourney/i, /\brevision\b/i, /trace[_-]?id/i, /\bE2E\b/i, /\be2e\b/, /\bmock\b/i, /\bseed\b/i, /\[HTTP_/],
  },
  {
    id: "L-09",
...
export const adminRoutes: readonly NewcomerTrainingAuditRoute[] = [
  ...
  { id: "A-03C", label: "客户问答口播录音任务", path: "/admin/sales-trainer/audio/customer-faq-oral-drill", critical: true, expectText: ["客户问答口播"], forbiddenText: adminForbiddenText },
  ...
  { id: "A-09B", label: "客户常见问答专题配置", path: "/admin/sales-trainer/learning-topics/customer-faq", critical: true, expectText: [/客户常见问答|问答卡片|学习专题/], forbiddenText: adminForbiddenText },
