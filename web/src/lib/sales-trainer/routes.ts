...
export const SALES_TRAINER_ADMIN_ROUTES = {
    ...
    audioSubmissionsInManagement: {
        ...
        label: "学员录音",
        icon: Activity,
        href: "/admin/newcomer-training/assessments",
    },
    audioScoreResults: {
    ...
    resourceLibrary: {
        ...
        label: "活动内容库",
        icon: Library,
        href: "/admin/newcomer-training/resources",
    },
    learnerProgress: {
        key: "learnerProgress",
        label: "学员进度",
    ...
    readiness: {
        ...
        label: "达标审核",
        icon: ClipboardCheck,
        href: "/admin/newcomer-training/reviews",
    },
    audioSubmissions: {
...
export const SALES_TRAINER_ADMIN_CONTENT_NAV_ITEMS = [
    ...
    SALES_TRAINER_ADMIN_ROUTES.resourceLibrary,
...
export const SALES_TRAINER_ADMIN_CONTEXT_NAV_GROUPS: readonly SalesTrainerAdminContextNavGroup[] = [
    ...
    },
    {
        ...
        items: [
            ...
            SALES_TRAINER_ADMIN_ROUTES.questionCategories,
        ],
    },
    {
        root: "/admin/newcomer-training/paths",
        label: "新人训练",
        roots: [
            "/admin/newcomer-training/paths",
            "/admin/newcomer-training/resources",
