...
export function teamJourneysQueryOptions(limit = 50, offset = 0) { return queryOptions({ queryKey: teamQueryKeys.journeys(limit, offset), queryFn: () => api.admin.newcomerTraining.listJourneys({ limit, offset }), ...defaults }); }
