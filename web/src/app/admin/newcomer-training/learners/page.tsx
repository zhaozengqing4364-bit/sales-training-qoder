...
export default function NewcomerTrainingLearnersPage() {
    ...
    const load = useCallback(async () => {
        ...
        try { setData(await api.admin.newcomerTraining.listJourneys({ search: search || undefined, limit: PAGE_SIZE, offset })); }
