...
export default function NewcomerTrainingLearnersPage() {
    ...
    return <main className="min-h-screen bg-slate-50 p-4 md:p-6"><div className="mx-auto max-w-6xl space-y-5"><AdminPageHeader title="学员进度" description="查看每位新人的当前主线、完成进度和下一步，具体评分与达标结论继续使用现有权威记录。" icon={<Users className="h-7 w-7 text-blue-600" />} />
