...
function getStageLabel(stage: TrainingJourneyStage | string | null | undefined): string {
    if (!stage) {
        return "未识别状态";
    }
...
function getStageToneClass(stage: TrainingJourneyStage | string | null | undefined): string {
...
// 看板面向 training_manager，不得直接展示工程 key。这里提供兜底中文模块名，
// 优先用 journey.modules[].title（受治理的运营文案）关联。
const MODULE_KEY_FALLBACK_LABELS: Record<string, string> = {
...
function buildModuleKeyToTitleMap(journeys: TrainingJourneyResponse[]): Map<string, string> {
