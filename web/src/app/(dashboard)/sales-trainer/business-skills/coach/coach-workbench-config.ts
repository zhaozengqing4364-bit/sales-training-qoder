...
export const BUSINESS_SKILLS_COACH_WORKBENCH_COPY = {
    ...
    activeSessionSubtitle: "训练卡主导，本轮先完成当前卡片",
    ...
    fallbackUnitDescription: "当前训练卡未命中具体小单元，先按教练给出的能力点完成训练。",
    noActiveCardTitle: "等待下一张训练卡",
    noActiveCardDescription:
        "可以继续下一题、查看讲解或总结本轮。自由追问只作为辅助，不会替代训练卡作答。",
    feedbackTitle: "教练反馈",
    ...
    endPanelWhy: "原因",
    endPanelNext: "下一步",
    conversationEvidenceTitle: "对话证据",
    followupPromptTitle: "教练给你的可选方向",
    commandBarLabel: "教练动作",
    followupPlaceholderWhenActive: "作答卡片是主流程；这里可以问教练一句",
    followupPlaceholderDefault: "问教练一句，或使用上方操作",
    sendAriaLabel: "发送",
    submitCardButton: "提交",
    submittedLabel: "已提交",
