        ...
        <GlassCard className="space-y-3 p-6">
            <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="flex gap-2">
                    <Link href="/admin/retrieval-strategies"><Button variant="outline" size="sm" className="rounded-full">去检索策略编辑</Button></Link>
                    <Link href="/admin/rag-profiles"><Button variant="outline" size="sm" className="rounded-full">管理 RAG Profile</Button></Link>
                </div>
            </div>
            <p className="rounded-xl border border-amber-200 bg-amber-50/90 px-3 py-2 text-xs text-amber-900">全局检索引擎在 <Link href="/admin/retrieval-strategies" className="font-semibold underline">检索策略</Link> 页配置。</p>
