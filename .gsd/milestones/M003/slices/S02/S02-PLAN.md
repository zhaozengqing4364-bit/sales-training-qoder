...
- [ ] **T01: Turn Persona policy into a structured customer-pressure model** `est:90m`
...
- [ ] **T02: Freeze the pressure model into the runtime compile and session snapshot chain** `est:90m`
