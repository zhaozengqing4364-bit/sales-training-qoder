...
- [ ] **T02: Render the weekly operating pack on the existing admin analytics route** — Render the weekly operating pack on the current admin analytics page using the new aggregation outputs. Keep the UI on the existing page and make it answer the practical questions: who is at risk, who is improving, what issue family repeats this week, and what changed in the asset layer.
  - Estimate: 90m
