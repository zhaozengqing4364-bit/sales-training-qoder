...
- [ ] **T02: 实现意图分类与检索规划器** — 实现 DB-driven intent classifier 与 retrieval planner。支持 regex / keyword / entity+keyword 三种 rule，输出 profile_key 与 progressive retrieval plan。
  - Estimate: 35-45m
