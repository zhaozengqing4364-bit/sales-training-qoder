...
- [ ] **T01: Documented the dashboard-home CTA closure strategy, kept export/share/goal affordances absent, and fixed the version-dialog dismiss action.** `est:30m`
...
- [ ] **T03: 为首页闭环补 focused proof** `est:30m`
