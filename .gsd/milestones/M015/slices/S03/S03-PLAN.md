...
- [ ] **T01: 建立 learner error/loading 与 lightweight UX baseline matrix** `est:30m`
...
- [ ] **T02: 补齐 learner route fallbacks 并修低风险 UX 问题** `est:1h`
...
- [ ] **T03: 锁定 learner shell baseline proof 与剩余风险** `est:25m`
