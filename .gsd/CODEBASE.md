...
Generated: 2026-04-14T08:44:52Z | Files: 500 | Described: 0/500
<!-- gsd:codebase-meta {"generatedAt":"2026-04-14T08:44:52Z","fingerprint":"56d634355fa49d186266ff75c2d7cd90ecb163f1","fileCount":500,"truncated":true} -->
...
- `AUDIT_REPORT.md`
- `CLAUDE.md`
- `FULL_STACK_AUDIT_REPORT_2025.md`
...
### .agent/evidence/20260213T134317Z/
- `.agent/evidence/20260213T134317Z/audit-index.json`
- `.agent/evidence/20260213T134317Z/audit-regression-matrix.md`
- `.agent/evidence/20260213T134317Z/run-meta.json`
- `.agent/evidence/20260213T134317Z/task-0-run-meta.json`
- `.agent/evidence/20260213T134317Z/task-1-audit-template.json`
- `.agent/evidence/20260213T134317Z/task-2-regression-matrix.md`
...
- `.codex/loop/log.md`
- `.codex/loop/output-schema.json`
- `.codex/loop/PROJECT_GROWTH.md`
- `.codex/loop/run-once-prompt.md`
...
### .codex/roadmap/runs/20260318-095543/
- `.codex/roadmap/runs/20260318-095543/events.jsonl`
- `.codex/roadmap/runs/20260318-095543/exit_code.txt`

### .codex/roadmap/runs/20260318-095607/
- `.codex/roadmap/runs/20260318-095607/events.jsonl`
- `.codex/roadmap/runs/20260318-095607/exit_code.txt`
...
- `.kiro/hooks/api-check.kiro.hook`
- `.kiro/hooks/api-contract-sync.kiro.hook`
- `.kiro/hooks/capability-check.kiro.hook`
- `.kiro/hooks/chinese-chat-reply.kiro.hook`
- `.kiro/hooks/frontend-check.kiro.hook`
- `.kiro/hooks/model-migration-check.kiro.hook`
- `.kiro/hooks/new-file-template-check.kiro.hook`
- `.kiro/hooks/python-check.kiro.hook`
- `.kiro/hooks/schema-check.kiro.hook`
- `.kiro/hooks/test-check.kiro.hook`
- `.kiro/hooks/websocket-check.kiro.hook`

### .kiro/specs/backend-platform-upgrade/
- `.kiro/specs/backend-platform-upgrade/requirements.md`
- `.kiro/specs/backend-platform-upgrade/tasks.md`
...
### .kiro/specs/frontend-rebuild/
- `.kiro/specs/frontend-rebuild/requirements.md`
- `.kiro/specs/frontend-rebuild/tasks.md`

### .kiro/specs/model-config-management/
- `.kiro/specs/model-config-management/design.md`
- `.kiro/specs/model-config-management/requirements.md`
- `.kiro/specs/model-config-management/tasks.md`

### .kiro/specs/voice-practice-optimization/
- `.kiro/specs/voice-practice-optimization/design.md`
- `.kiro/specs/voice-practice-optimization/requirements.md`
- `.kiro/specs/voice-practice-optimization/tasks.md`

### .kiro/steering/
- `.kiro/steering/backend-principles.md`
- `.kiro/steering/frontend-principles.md`
- `.kiro/steering/QUICK-REFERENCE.md`
- `.kiro/steering/README.md`
- `.kiro/steering/rule.md`
- `.kiro/steering/testing-principles.md`
- `.kiro/steering/ui-ux-pro-max.md`

### .kiro/templates/backend/
- `.kiro/templates/backend/api_route.py`
- `.kiro/templates/backend/capability.py`
- `.kiro/templates/backend/websocket_handler.py`

### .kiro/templates/frontend/
- `.kiro/templates/frontend/component.tsx`
- `.kiro/templates/frontend/hook.ts`
- `.kiro/templates/frontend/page.tsx`

### .playwright-mcp/
- `.playwright-mcp/page-2026-04-02T15-50-45-954Z.yml`
- `.playwright-mcp/page-2026-04-02T15-51-10-461Z.yml`
- `.playwright-mcp/page-2026-04-02T15-54-31-982Z.yml`
- `.playwright-mcp/page-2026-04-02T15-54-32-999Z.yml`
...
- `.shared/ui-ux-pro-max/data/stacks/nuxt-ui.csv`
- `.shared/ui-ux-pro-max/data/stacks/nuxtjs.csv`
...
- `.sisyphus/evidence/cloud-redeploy-115-191-36-90/rsync-checksum-dryrun.txt`

### .sisyphus/evidence/db-sync/
- `.sisyphus/evidence/db-sync/local_pg_counts.json`
- `.sisyphus/evidence/db-sync/local-ai_practice-20260214-121056.sql`
- `.sisyphus/evidence/db-sync/remote_pg_counts.json`

### .sisyphus/evidence/voice-flow-check/
- `.sisyphus/evidence/voice-flow-check/setup_presentation_fixture_remote.py`
- `.sisyphus/evidence/voice-flow-check/voice_flow_e2e_check.py`
- `.sisyphus/evidence/voice-flow-check/voice-flow-verification-report.md`

### .sisyphus/plans/
- `.sisyphus/plans/cloud-full-redeploy-115-191-36-90.md`
- `.sisyphus/plans/ppt-flow-full-repair-and-role-design.md`
- `.sisyphus/plans/ulw-audit-readonly-report.md`
- `.sisyphus/plans/ulw-audit-readonly-report.zh-CN.md`

### .specify/
- `.specify/voice-practice-optimization.md`

### .specify/memory/
- `.specify/memory/coding-standards.md`
- `.specify/memory/constitution.md`
- `.specify/memory/frontend-standards.md`
...
- `backend/process_pending_docs.py`
- `backend/pyproject.toml`
- `backend/reprocess_failed_docs.py`
- `backend/requirements.txt`
- `backend/reset_db.py`
- `backend/sitecustomize.py`

### backend/.github/workflows/
- `backend/.github/workflows/nfr-performance-check.yml`
...
### backend/data/chromadb/5e77e81d-bb1e-4b1d-ada4-f410884749e1/
- `backend/data/chromadb/5e77e81d-bb1e-4b1d-ada4-f410884749e1/index_metadata.pickle`

### backend/data/documents/c6dad7ec-4673-4e00-acc1-0de190a88198/
- `backend/data/documents/c6dad7ec-4673-4e00-acc1-0de190a88198/14543cc5-09e8-45ae-9bfa-eff7d56e3f77.docx`
- `backend/data/documents/c6dad7ec-4673-4e00-acc1-0de190a88198/cbefd65e-4add-4ccc-b62d-5eaea1bfa65a.docx`
- `backend/data/documents/c6dad7ec-4673-4e00-acc1-0de190a88198/e3469463-c19a-4122-abc4-fefb0853243e.docx`
...
- `backend/scripts/verify_aliyun_config.py`

### backend/src/
- `backend/src/main.py`

### backend/src/admin/api/
- `backend/src/admin/api/__init__.py`
...
- `backend/src/agent/api/__init__.py`
- `backend/src/agent/api/agent_personas.py`
- `backend/src/agent/api/agents.py`
- `backend/src/agent/api/personas.py`

### backend/src/agent/capabilities/
- `backend/src/agent/capabilities/__init__.py`
- `backend/src/agent/capabilities/base.py`
- `backend/src/agent/capabilities/fuzzy_detection.py`
- `backend/src/agent/capabilities/knowledge_retrieval.py`
- `backend/src/agent/capabilities/realtime_scoring.py`
- `backend/src/agent/capabilities/registry.py`
- `backend/src/agent/capabilities/runner.py`
- `backend/src/agent/capabilities/sales_stage.py`

### backend/src/agent/migrations/
- `backend/src/agent/migrations/__init__.py`
- `backend/src/agent/migrations/migrate_persona_policy.py`
...
### backend/src/common/ai/
- `backend/src/common/ai/__init__.py`
- `backend/src/common/ai/config_manager.py`
- `backend/src/common/ai/embedding_service.py`
- `backend/src/common/ai/encryption.py`
- `backend/src/common/ai/llm_service.py`
- `backend/src/common/ai/models.py`
- `backend/src/common/ai/schemas.py`

### backend/src/common/analytics/
- `backend/src/common/analytics/admin_analytics_service.py`
- `backend/src/common/analytics/analytics_service.py`
...
- `backend/src/common/analytics/runtime_metrics_service.py`
- `backend/src/common/analytics/verification_runner.py`

### backend/src/common/api/
- `backend/src/common/api/__init__.py`
- `backend/src/common/api/analytics.py`
- `backend/src/common/api/dashboard.py`
- `backend/src/common/api/knowledge_debug.py`
- `backend/src/common/api/practice.py`
- `backend/src/common/api/response.py`
- `backend/src/common/api/server_error.py`
- `backend/src/common/api/training.py`
- `backend/src/common/api/users.py`

### backend/src/common/audio/
- `backend/src/common/audio/aliyun_streaming_tts.py`
- `backend/src/common/audio/asr_alibaba.py`
- `backend/src/common/audio/asr_base.py`
- `backend/src/common/audio/asr_local.py`
- `backend/src/common/audio/asr_service.py`
- `backend/src/common/audio/asr_streaming.py`
- `backend/src/common/audio/asr_with_fallback.py`
- `backend/src/common/audio/tts_factory.py`
...
- `backend/src/common/cache/redis_cache.py`
- `backend/src/common/cache/response_cache.py`

### backend/src/common/conversation/
- `backend/src/common/conversation/api.py`
- `backend/src/common/conversation/engine.py`
...
- `backend/src/common/error_handling/middleware.py`
- `backend/src/common/error_handling/result.py`

### backend/src/common/jobs/
- `backend/src/common/jobs/audio_archival.py`

### backend/src/common/knowledge/
- `backend/src/common/knowledge/api.py`
- `backend/src/common/knowledge/bm25_index.py`
- `backend/src/common/knowledge/ingestion_service.py`
...
- `backend/src/common/knowledge/rag_profile_models.py`
- `backend/src/common/knowledge/rag_profile_service.py`
- `backend/src/common/knowledge/schemas.py`
- `backend/src/common/knowledge/semantic_cache.py`
...
- `backend/src/common/knowledge_engine/cross_encoder_reranker.py`
...
- `backend/src/common/logging/sanitizer.py`

### backend/src/common/middleware/
- `backend/src/common/middleware/auth.py`
...
- `backend/src/common/monitoring/otel.py`
- `backend/src/common/monitoring/trace_context.py`

### backend/src/common/oss/
- `backend/src/common/oss/__init__.py`
- `backend/src/common/oss/signing.py`

### backend/src/common/ppt/
- `backend/src/common/ppt/ocr_processor.py`
- `backend/src/common/ppt/version_manager.py`

### backend/src/common/rate_limit/
- `backend/src/common/rate_limit/api_limiter.py`
- `backend/src/common/rate_limit/session_limiter.py`

### backend/src/common/resilience/
- `backend/src/common/resilience/backoff.py`
- `backend/src/common/resilience/circuit_breaker.py`
...
- `backend/src/common/storage/audio.py`
- `backend/src/common/storage/document.py`
- `backend/src/common/storage/presentation.py`

### backend/src/common/validation/
- `backend/src/common/validation/file_validator.py`
- `backend/src/common/validation/html_sanitizer.py`
- `backend/src/common/validation/input_validator.py`
...
- `backend/src/evaluation/schemas.py`

### backend/src/evaluation/services/
- `backend/src/evaluation/services/__init__.py`
...
### backend/src/evaluation/triggers/
- `backend/src/evaluation/triggers/__init__.py`
- `backend/src/evaluation/triggers/base_trigger.py`
- `backend/src/evaluation/triggers/keyword.py`
- `backend/src/evaluation/triggers/stage_transition.py`
- `backend/src/evaluation/triggers/time_interval.py`
- `backend/src/evaluation/triggers/turn_count.py`

### backend/src/evaluation/websocket/
- `backend/src/evaluation/websocket/__init__.py`
- `backend/src/evaluation/websocket/broadcaster.py`

### backend/src/presentation_coach/api/
- `backend/src/presentation_coach/api/presentations.py`

### backend/src/presentation_coach/services/
- `backend/src/presentation_coach/services/aho_matcher.py`
- `backend/src/presentation_coach/services/coach_service.py`
- `backend/src/presentation_coach/services/feedback_service.py`
- `backend/src/presentation_coach/services/forbidden_matcher.py`
- `backend/src/presentation_coach/services/interruption_detector.py`
- `backend/src/presentation_coach/services/point_extraction.py`
- `backend/src/presentation_coach/services/point_tracker.py`
- `backend/src/presentation_coach/services/ppt_parser.py`
- `backend/src/presentation_coach/services/presentation_ai_policy_service.py`
...
- `backend/src/presentation_coach/services/semantic_point_tracker.py`
...
### backend/src/presentation_coach/websocket/components/
- `backend/src/presentation_coach/websocket/components/__init__.py`
- `backend/src/presentation_coach/websocket/components/presentation_event_emitter.py`
...
### backend/src/sales_bot/api/
- `backend/src/sales_bot/api/scenarios.py`

### backend/src/sales_bot/prompts/
- `backend/src/sales_bot/prompts/persona_prompts.py`

### backend/src/sales_bot/services/
- `backend/src/sales_bot/services/bot_service.py`
...
- `backend/src/sales_bot/services/vagueness_detector.py`
- `backend/src/sales_bot/services/voice_instruction_compiler.py`
- `backend/src/sales_bot/services/voice_policy_monitor.py`
- `backend/src/sales_bot/services/voice_runtime_policy.py`

### backend/src/sales_bot/websocket/
...
- `backend/src/sales_bot/websocket/sales_handler.py.deprecated`
- `backend/src/sales_bot/websocket/simple_handler.py`
- `backend/src/sales_bot/websocket/stepfun_realtime_handler.py`

### backend/src/sales_bot/websocket/components/
- `backend/src/sales_bot/websocket/components/__init__.py`
...
- `backend/src/sales_bot/websocket/components/score_processor.py`
- `backend/src/sales_bot/websocket/components/stepfun_event_payloads.py`
- `backend/src/sales_bot/websocket/components/stepfun_function_call_helpers.py`
...
- `backend/src/sales_bot/websocket/components/tts_component.py`

### backend/src/support/
- `backend/src/support/__init__.py`

### backend/src/support/api/
- `backend/src/support/api/__init__.py`
...
- `backend/src/training_runtime/__init__.py`
...
- `backend/tests/contract/test_ppt_upload.py`
...
- `backend/tests/contract/test_scenarios.py`
