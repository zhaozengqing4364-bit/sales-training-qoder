...
def upgrade() -> None:
    ...
    op.create_index("ix_achievements_enabled", "achievements", ["enabled"], unique=False)
    ...
    op.create_index("ix_notifications_source", "notifications", ["source"], unique=False)
    ...
    op.create_table(
        ...
        sa.CheckConstraint("period IN ('weekly', 'monthly')", name="ck_user_goal_period"),
    ...
    op.create_index("ix_user_goals_is_active", "user_goals", ["is_active"], unique=False)
    op.create_index("idx_user_goals_user_active", "user_goals", ["user_id", "is_active"], unique=False)
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["session_id"], ["practice_sessions.session_id"], ondelete="SET NULL"),
        sa.ForeignKeyConstraint(["user_id"], ["users.user_id"], ondelete="CASCADE"),
    ...
    op.create_index("ix_user_achievements_session_id", "user_achievements", ["session_id"], unique=False)
    op.create_index("ix_user_achievements_unlocked_at", "user_achievements", ["unlocked_at"], unique=False)
    op.create_index("idx_user_achievements_user_unlocked", "user_achievements", ["user_id", "unlocked_at"], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index("ix_user_achievements_session_id", table_name="user_achievements")
    ...
    op.drop_index("ix_user_goals_is_active", table_name="user_goals")
    ...
    op.drop_index("ix_achievements_enabled", table_name="achievements")
