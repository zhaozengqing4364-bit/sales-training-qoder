...
async def score_audio_submission(
    db: AsyncSession,
    submission_id: str,
    *,
    actor: User | None = None,
) -> SalesTrainerAudioSubmission:
    """Thin task wrapper so queues can call scoring without API coupling."""

    return await AudioSubmissionService(db).score_submission(
