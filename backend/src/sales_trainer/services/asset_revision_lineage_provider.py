...
from common.assets.lineage import register_asset_revision_lineage_provider
from sales_trainer.models import (
    SalesTrainerAssetActiveRevision,
    SalesTrainerAssetRevision,
)

SALES_TRAINER_ASSET_REVISION_LINEAGE_PROVIDER: Final = "sales_trainer.asset_revision"
...
async def sales_trainer_asset_revision_lineage_provider(
    db: AsyncSession,
    asset_type: str,
    logical_id: str,
) -> dict[str, Any]:
...
def register_sales_trainer_asset_revision_lineage_provider() -> None:
    register_asset_revision_lineage_provider(
        SALES_TRAINER_ASSET_REVISION_LINEAGE_PROVIDER,
        sales_trainer_asset_revision_lineage_provider,
    )
