...
class KnowledgeBaseBase(BaseModel):
    ...
    description: str | None = Field(None, max_length=500, description="Knowledge base description")
...
class KnowledgeDocumentResponse(KnowledgeDocumentBase):
    ...
    file_type: DocumentFileTypeType = Field(..., description="File type: pdf|docx|txt|md")
...
class KnowledgeBaseSuccessResponse(BaseModel):
    ...
    success: bool = True
    data: KnowledgeBaseResponse | KnowledgeBaseCreateResponse | KnowledgeBaseListResponse | None = None
...
class KnowledgeDocumentSuccessResponse(BaseModel):
    ...
    success: bool = True
    data: KnowledgeDocumentResponse | KnowledgeDocumentUploadResponse | KnowledgeDocumentListResponse | DocumentPreviewResponse | None = None
    trace_id: str | None = None
