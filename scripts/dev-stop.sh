...
PORTS_TO_CLEAN="${PORTS_TO_CLEAN:-${BACKEND_PORT},${TASK_WORKER_PROBE_PORT},${OUTBOX_DISPATCHER_PROBE_PORT},${FRONTEND_PORT}}"
...
main() {
  ...
  stop_pid_file "task-worker"
  stop_pid_file "outbox-dispatcher"
