...
BACKEND_GATE_TARGETS=(
  ...
  # Keep material governance and prerequisite coverage explicit while the
  # pre-existing platform-admin public-route assertion is governed separately.
  "tests/integration/test_newcomer_training_path_material_api.py::test_should_audit_published_material_metadata_update_via_api"
  "tests/integration/test_newcomer_training_path_material_api.py::test_should_preview_and_rollback_material_version_via_api"
  "tests/integration/test_newcomer_training_path_material_api.py::test_should_upload_material_file_and_create_draft_version_via_api"
  "tests/integration/test_newcomer_training_path_material_api.py::test_should_unlock_dependent_material_only_with_active_revision_evidence"
  "tests/integration/test_newcomer_training_path_material_api.py::test_should_enforce_object_scope_for_material_file_download"
  "tests/integration/test_newcomer_training_path_material_api.py::test_should_replay_archived_material_version_from_training_record"
  ...
  "tests/unit/test_path_prerequisite_policy.py"
  "tests/unit/test_newcomer_training_path_audio_lineage.py::test_should_block_dependent_audio_submission_until_active_revision_evidence"
  ...
  "tests/unit/test_sales_trainer_services.py::test_should_project_sales_trainer_path_with_unlock_progress_and_prerequisite_parity"
  # Explicit realtime nodes preserve the established start/readiness coverage while
  # the pre-existing admin learner-entry permission assertion is governed separately.
  "tests/unit/test_sales_trainer_realtime_roleplay_start.py::test_start_realtime_roleplay_creates_session_with_external_binding"
  "tests/unit/test_sales_trainer_realtime_roleplay_start.py::test_start_realtime_roleplay_fails_without_active_revision"
  "tests/unit/test_sales_trainer_realtime_roleplay_start.py::test_start_realtime_roleplay_fails_when_provider_not_ready"
  "tests/unit/test_sales_trainer_realtime_roleplay_start.py::test_start_realtime_roleplay_fails_when_module_is_locked_by_learner_level"
  "tests/unit/test_sales_trainer_realtime_roleplay_start.py::test_start_realtime_roleplay_requires_active_revision_prerequisite_evidence"
  "tests/unit/test_sales_trainer_realtime_roleplay_start.py::test_start_realtime_roleplay_fails_when_registry_is_disabled"
